...
This project involved substantial real-world debugging beyond the initial model training — including discovering and resolving a train/serve skew issue through systematic comparison of live-extracted features against dataset ground truth. See project_summary_scraping_to_final_model.md for the full debugging writeup.